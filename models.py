...
class ReservationInformation(db.Model):
    ...
    bedType = db.Column(db.String(6), nullable=False)
    smokingPref = db.Column(db.String(11), nullable=False)
    additionalReq = db.Column(db.String(100), nullable=False, default='None')
...
class CompanionInformation(db.Model):
    ...
    compEmail = db.Column(db.String(60), unique=True, nullable=False)
...
class RoomPrice(db.Model):
    ...
    roomType = db.Column(db.String(6), primary_key=True)
